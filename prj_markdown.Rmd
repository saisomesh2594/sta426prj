...
figs(name="eventcount_files","Total number of events per file")
...
figs("eventcount_files",display="cite")

data_analysis = matrix(data=NA, nrow=16, ncol=10)
colnames(data_analysis) = c("CD3","CD45","CD4","CD20","CD33","CD123","CD14","igM","HLA-DR","CD7")
...
avgintensity = matrix(data=NA, nrow=1000, ncol=10)
