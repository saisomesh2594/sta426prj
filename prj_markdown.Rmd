...
```{r}
regularizationThresholds = citrus.generateRegularizationThresholds(medianFeatures,labels,modelType="pamr", family="classification")
```
...
#Build final model
```{r}
finalModel = citrus.buildEndpointModel(medianFeatures,labels,family="classification",type="pamr",regularizationThresholds)
